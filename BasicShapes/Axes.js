...
class Axes {
  constructor (gl, prog) {
    ...
    this.xaxis = new Cylinder(gl, prog, 0.03, 0.03, 0.9, 20, xcolor, xcolor);
    this.yaxis = new Cylinder(gl, prog, 0.03, 0.03, 0.9, 20, ycolor, ycolor);
    this.zaxis = new Cylinder(gl, prog, 0.03, 0.03, 0.9, 20, zcolor, zcolor);
